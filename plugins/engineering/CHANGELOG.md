...
All notable changes to the engineering plugin will be documented in this file.
...
- **git-worktree skill** - Replace slashes in branch names with `__` for worktree directory names to avoid nested directory issues
