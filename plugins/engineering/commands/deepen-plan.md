...
# 3. engineering plugin skills
ls ~/.claude/plugins/cache/*/engineering/*/skills/
...
**Important:** Check EVERY source. Don't assume engineering is the only plugin. Use skills from ANY installed plugin that's relevant.
...
# 3. engineering plugin agents (all subdirectories)
find ~/.claude/plugins/cache/*/engineering/*/agents -name "*.md" 2>/dev/null
...
- engineering plugin (but SKIP workflow/ agents - only use review/, research/, design/, docs/)
- ALL other installed plugins (agent-sdk-dev, frontend-design, etc.)
- Any local plugins

**For engineering plugin specifically:**
