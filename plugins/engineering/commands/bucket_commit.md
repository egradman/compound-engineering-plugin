...
Based on the above changes, propose multiple commits that group like changes.  Ask the user to approve your buckets and give them the opporunity to move things around or skip stuff.
